    ...
    <div className='relative w-full h-screen flex justify-center flex-col'>
      ...
      <div className='w-[90%] md:w-[80%] mx-auto items-center grid grid-cols-1 xl:grid-cols-2 gap-10'>
        ...
        <div>
          ...
          {/* button */}
          <a href="https://help.gohighlevel.com/support/solutions/articles/155000003906-ai-employee-overview" target='_blank' className='relative mt-8 inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group'>
